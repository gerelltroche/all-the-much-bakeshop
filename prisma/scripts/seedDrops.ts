...
export default async function seedDrops() {
  ...
  const candyCaneLane = await prisma.drop.upsert({
    ...
    update: {
      ...
      dropOpens: new Date('2025-12-07T23:59:59Z'),
      pickupDate: new Date('2025-12-21T10:00:00Z'),
      deliveryDates: [
        new Date('2025-12-22T10:00:00Z'),
        new Date('2025-12-23T10:00:00Z'),
      ],
      pickupLocation: 'TBD',
      cutoffDate: new Date('2025-12-15T23:59:59Z'),
      isActive: true,
      maxCookies: 72,
    },
    create: {
  ...
  const catchMeIfYouCan = await prisma.drop.upsert({
    ...
    update: {
      name: "Can't Catch Me",
      dropOpens: new Date('2025-12-20T23:59:59Z'),
      pickupDate: new Date('2025-12-23T10:00:00Z'),
      deliveryDates: [
        new Date('2025-12-23T10:00:00Z'),
        new Date('2025-12-24T10:00:00Z'),
      ],
      pickupLocation: 'The Bakeshop - 123 Main St, Chicago IL',
      cutoffDate: new Date('2025-12-20T23:59:59Z'),
      isActive: true,
      maxCookies: 72,
    },
    create: {
  ...
  const sweaterWeather = await prisma.drop.upsert({
    ...
    update: {
      ...
      dropOpens: new Date('2026-01-10T23:59:59Z'),
      pickupDate: new Date('2026-01-15T10:00:00Z'),
      deliveryDates: [
      ...
      pickupLocation: 'The Bakeshop - 123 Main St, Chicago IL',
      cutoffDate: new Date('2026-01-10T23:59:59Z'),
      isActive: true,
      maxCookies: 72,
    },
    create: {
